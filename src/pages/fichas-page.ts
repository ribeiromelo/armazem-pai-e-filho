...
<body class="bg-gray-50">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-800" id="totalCredit">R$ 0,00</p>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-800" id="totalCash">R$ 0,00</p>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-800" id="totalGeneral">R$ 0,00</p>
                            </div>
    ...
    <div id="sheetModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50">
        <div class="bg-white rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form id="sheetForm">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Mercadoria em Estoque</label>
                    <textarea id="stockMerchandise" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Ex: 50 sacas de feijão"></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="observations" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></textarea>
                </div>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            const total = creditTotal + envelopeMoney;
...
Estoque: \${sheet.stock_merchandise || 'N/A'}
...
Criada por: \${sheet.created_by_name}
        ...
        function editSheet(id) {
            ...
            if (sheet) {
                ...
                document.getElementById('stockMerchandise').value = sheet.stock_merchandise || '';
        ...
        document.getElementById('sheetForm').addEventListener('submit', async (e) => {
            ...
            const data = {
                ...
                stock_merchandise: document.getElementById('stockMerchandise').value,
